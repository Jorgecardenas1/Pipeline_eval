...
class Swarm:
    ...
    #     # Solo se van actualizando en el transcurso de las iteraciones
        ...
        phi = 0.48-((0.48-0.4)*iteration/(50) )# adaptive inertia method
        self.phiv =phi
        print(phi)
        
        phi1 = 2.1 #valores que se pueden revisar. Seguir el valor el mejor fit propio
        phi2 = 1.8 #esto va valores componen self-knowledge.  seguir el mejor fit global
