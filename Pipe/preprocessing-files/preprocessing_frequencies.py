...
imagesPath="./data/MetasurfacesDataV3RESNET/Images/processed512"
imagesDestination="./data/MetasurfacesDataV3RESNET/Images-512-Bands"
testDestination="./data/MetasurfacesDataV3RESNET/testImages"
...
def join_imagesData():
    ...
    df.to_csv('outImages.csv',index=False)
